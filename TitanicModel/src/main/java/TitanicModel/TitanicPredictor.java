...
public class TitanicPredictor {
    public static void main(String[] args) throws IOException, URISyntaxException, InvocationTargetException, InterruptedException {
        DataFrame trainingData = readCSV("E:\\titanic_train.csv");
        DataFrame testData = readCSV("E:\\titanic_test.csv");
...
//        titanicSurvived.doubleVector ("Age").toDoubleArray (), 15, false
